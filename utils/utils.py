...
def calc_dist(X):
  """
  Computes the lenghts of each limb in a given pose.
  """
...
def dist_medie(dict_joints):
  """
  Computes the average lenghts of each limb in a given dataset, composed by all the poses in dict_joints.
  """
...
def load_poses(dir_im, dir_joints):
  """
  Load the poses from a given dir_joints directory, based on the name of respective images in the dir_im directory.
  The conventions of joints and images names are based on the OpenPose ones. https://github.com/CMU-Perceptual-Computing-Lab/openpose
  """
  dict_joints = {}
